...
export class ProductItem {    
	...
	props: {        
		product: Product,        callback: (product: Product, quantity: number) => void    
	}    
	getContent(): HTMLElement {        
		return <div className="card m-1 p-1 bg-light">            
			...
			<div className="card-text bg-white p-1">                
				...
				<select className="form-control-inline float-right m-1" onchange={ this.handleQuantityChange }>                    					<option>1</option>
					<option>2</option>
					<option>3</option>
				</select>
			</div>        
